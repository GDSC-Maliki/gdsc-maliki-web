...
@section('content-division')
    <section id="team" class="team section-bg hero">
        <div class="container" data-aos="fade-up">

            <div class="section-title">
                <h2>Developer and Speakers</h2>
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                    <div class="member">
                        <div class="member-img">
                            <img src="{{ asset('landing/assets/img/team/team-3.jpeg') }}" class="img-fluid" alt="">
                            <div class="social">
            ...
            <div class="row justify-content-md-center">
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                    <div class="member">
                        <div class="member-img">
                            <img src="{{ asset('landing/assets/img/team/team-4.jpeg') }}" class="img-fluid" alt="">
                            <div class="social">
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="400">
                    <div class="member">
                        <div class="member-img">
                            <img src="{{ asset('landing/assets/img/team/team-5.jpeg') }}" class="img-fluid" alt="">
                            <div class="social">
